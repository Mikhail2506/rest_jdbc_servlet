...
public class PersonToSectionDBQueries {
    ...
    public static final String FIND_ALL_BY_PERSONID_SQL = """
            SELECT persons_sections_id, person_id, section_id FROM public.person_section
            WHERE person_id = ?;
            """;

    public static final String FIND_ALL_BY_SECTION_ID_SQL = """
            SELECT persons_sections_id, person_id, section_id FROM public.person_section
            WHERE section_id = ?;
            """;

    public static final String FIND_BY_USPERSON_ID_AND_SECTION_ID_SQL = """
            SELECT persons_sections_id, person_id, section_id FROM public.person_section
